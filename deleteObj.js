...
{	
	...
	{
		for ( var i = 0; i < arrWallFront.total.length; i++ ) { if(arrWallFront.total[i] == obj) { arrWallFront.total.splice(i, 1); break; } }
	}
...
function deleteObjCatalog( obj ) 
{
	...
	for (var i = 0; i < arr_obj.length; i++) { if(arr_obj[i] == obj) { arr_obj.splice(i, 1); break; } }
	...
	if(clickO.obj == obj || clickO.last_obj == obj)
	{
		...
		{ 	
			for ( var i = 0; i < arrWallFront.objPop.obj_1.length; i++ ) { if(arrWallFront.objPop.obj_1[i] == obj) { arrWallFront.objPop.obj_1.splice(i, 1); break; } }  
			showSizeFormat_3();
			
			for ( var i = 0; i < arrWallFront.total.length; i++ ) { if(arrWallFront.total[i] == obj) { arrWallFront.total.splice(i, 1); break; } }
	 
			hideMenuObjUI_Wall( obj ); 
		}
