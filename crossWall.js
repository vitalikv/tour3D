...
// интерполяция (t - текущее значение, p0 - старт, p1 - насколько смещен центр, p2 - конец)
function interpolationsQuadratic( t, p0, p1, p2 ) 
{
...
//https://otvet.mail.ru/question/57405256
// найти число методом интерполяции
// ratioDifferenceNumber({ x1: 7, x2: 10, y1: 2400, y2: 2600, t : 8.87}))
// как делается - на разницу 10-7 = 3 приходится 2600-2400 = 200
// на одну единицу - 200/3 = 66,67
// 8.87 - 7 =1,87 Х 66,67 = 124,67
// 2400 +124,67 = 2524,67
function ratioDifferenceNumber(cdm)
{	
	var x = cdm.x2 - cdm.x1;
	var y = cdm.y2 - cdm.y1;
	
	return (cdm.t - cdm.x1) * (y/x) + cdm.y1;
}
