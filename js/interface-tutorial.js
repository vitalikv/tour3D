...
function getIHelp(tutorialName, index) {
  ...
  if (!activeTutorial) {
    ...
    obj.next.on('click touchstart', function () {
    ...
    obj.prev.on('click touchstart', function () {
      if (!activeTutorial) return;
      activeTutorial.index--;
    ...
    if (iHelp[tutorialName].items[index].showMore) {
      ...
      obj.close.on('click touchstart', function () {
        showIHelp('units');
      })
    }
    obj.close.on('click touchstart', function () {
...
function showIHelp(tutorialName, start) {
  ...
  activeTutorial.el.on('mousedown wheel DOMMouseScroll mousewheel mousemove touchstart touchend touchmove', function (e) {
    e.stopPropagation();
  });
...
function showHotkeys() {
  ...
  $el.find('.i-help__next').on('click touchstart', function () {
    $('.i-help--hotkeys').remove();
    showIHelp('catalog');
  })
  $el.find('.i-help__close').on('click touchstart', function () {
  ...
  $('.ui-layer').append($el);
  $el.on('mousedown wheel DOMMouseScroll mousewheel mousemove touchstart touchend touchmove', function (e) {
    e.stopPropagation();
  });
}
