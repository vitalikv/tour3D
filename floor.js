...
{	
	...
	room[n] = new THREE.Mesh( new THREE.ExtrudeGeometry( shape, { bevelEnabled: false, depth: -arrW[0].userData.wall.height_0 } ), new THREE.MeshLambertMaterial( { color : 0xe3e3e5, lightMap : lightMap_1 } ) ); 
...
{  
	...
	{	 
		...
		var geometry = new THREE.ExtrudeGeometry( shape, { bevelEnabled: false, depth: -arrRoom[i].w[0].userData.wall.height_0 } ); 
