...
function forceAssignActiveObj(obj)
{
	...
	else if ( camera == cameraWall ) { showMenuObjUI_Wall(clickO.obj); }	
}
...
function setInfoEvent22()
{
	...
	loadPopObj_1({ obj: findObjFromId( ar.wall.tag, ar.wall.id ), lotid: ar.wall.material.lotid, index: ar.wall.material.index, color : ar.wall.material.color, scale : ar.wall.material.scale });	
}
