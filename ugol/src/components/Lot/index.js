...
const Lot = ({ image, type, typeOnPlan, lotGroup, id, name, price, caption, handleClick, activeLot, size, modifiers, allModifiers, data }) => {
  ...
  return (
    <div className='products__item-wrap' data-id={id} onClick={() => !isActive && handleClick(type, lotGroup, typeOnPlan, id, name, image, price, caption, size, modifiers, allModifiers, data)}>
